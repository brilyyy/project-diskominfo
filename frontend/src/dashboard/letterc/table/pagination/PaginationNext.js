...
const PaginationNext = ({onClick, disable}) => {
    return(
        <div 
        className={"h-8 w-8 ml-1 flex justify-center items-center rounded-md " + (!disable ? " bg-gray-200 cursor-pointer hover:bg-gray-300" : "bg-gray-100 cursor-not-allowed hover:bg-gray-100" )}
