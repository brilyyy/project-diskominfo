...
const Table = (props) => {
  ...
  const handleDelete = () => {
    axios
      .delete(API.url + "krawangan/details/" + activeItem, {
        headers: {
          Authorization:
            "Bearer " + window.sessionStorage.getItem("accessToken"),
        },
                ...
                krawangansData.map((krawangan, key) => (
                  ...
                  >
                    ...
                    <td className="border border-gray-300 p-1">
                      <button
                        type="button"
                        className="focus:outline-none text-white text-sm p-2 bg-red-500 rounded-md hover:bg-red-600 hover:shadow-lg"
                        onClick={() => {
                          setDeleteModal(true);
                          setActiveItem(krawangan.id);
                          setNamaItem(krawangan.no_persil);
                        }}
                      >
                        <BiTrash />
                      </button>
